...
for j in range(1, num_msrs + 1):
    Exprs = []
    for i in range(1, num_ieds + 1):
        Exprs.append(And (Ied_msr_relation[i][j], CommPath[i]))
...
## Delivery of unique measurements (multiple) with regards to bus consumptions
...
while True:
    ...
    f_write = open('Output_ICS_B.txt', 'a')
